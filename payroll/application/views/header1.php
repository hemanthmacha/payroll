...
<nav class="navbar navbar-default" style="background-color:#e9edf0;">
  <div class="container-fluid">
    ...
    <div class="logout1"><a href="<?=base_url()?>">  <button id="abc">Logout </button> </a> </div>
    <?php } ?>
    ...
    <div class="logout"><h4><?php echo ($this->session->userdata('fname')); echo" "; echo ($this->session->userdata('lname')); ?> </h4><a href="<?=base_url()?>"> <button id="abc">Logout </button>  </a> </div>
...
<script type="text/javascript">
  ...
  <?php $this->session->unset_userdata('role'); ?>
