...
so here calculation will be like -->
		...
		<p style="font-size: 15px"> Amount = 400 </p> 		 	
</div>
		<div class="column">
		...
		<p style="font-size: 15px"><b>3.&emsp;</b>(17 * 50 *(30/100) +(3 * 80*(50/100))) = 375</p>
		 --><p style="font-size: 15px"><b>1.&emsp;</b>5 * 80 *(50/100) =200 </p>
		  <p style="font-size: 15px"><b>2.&emsp;</b>(38 * 70 *(40/100)) = 1064</p>
		  <p style="font-size: 15px"> Billed hours = 97&nbsp;(54+43)</p>
		  <p style="font-size: 15px"> Amount = 1464 </p> 		 	
</div>
<div class="column">	<p style="font-size: 15px"><B>TOTAL BILLEDHOURS = 98</B><br><br><B>TOTAL AMOUNT = 4164</B> </p> 		 	
...
<div class="container"><input type="button" class="btn btn-primary back" value="Back" onclick="history.back()"> </div>
